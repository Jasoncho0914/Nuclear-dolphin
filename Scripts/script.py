...
from Utility import createLabeled
from Utility import createTrain
from Utility import runRandomForest
...
def createLabel(seed, data, graph):
    ...
    X = [x[:27] for x in embedding]
    # X = data[:6000]

    #spectral clustering
    clf = SpectralClustering(n_clusters=10, gamma=0.4)
